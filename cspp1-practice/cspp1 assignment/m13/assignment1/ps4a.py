        ...
        # If the word is not valid:
         ...
         # Reject invalid word (print a message followed by a blank line)
            if not isValidWord(user_input,hand,wordList):
                ...
                word_score = getWordScore(user_input,HAND_SIZE)
                total_score = total_score + word_score
                print("the total score is ",word_score)
                print()
...
def playGame(wordList):
    ...
    while True:
        user_input = input("enter input n(to play new random hand) , r(to play last hand),e(to exit) :")
        if user_input == 'n':
